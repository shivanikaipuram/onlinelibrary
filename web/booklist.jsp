<%-- 
    Document   : booklist
    Created on : Jul 8, 2016, 12:27:28 PM
    Author     : shivani
--%>
        ...
        <table id="example" style="background-color: black; color:white" border="1" cellpadding="5" class="table" class="table-responsive" >
            ...
            <c:forEach var="bk" items="${list.rows}">
                <tr>
                    ...
                    <td><a href ="${bk.pdf}" ><span class="glyphicon glyphicon-download"><input type="submit" class="btn btn-info" value="Download"/></span></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
