<%-- 
    Document   : libbooklist
    Created on : Jul 19, 2016, 3:58:30 PM
    Author     : shivani
--%>
                ...
                <tbody>
                    <c:forEach var="bk" items="${list.rows}">
                        <tr>
                            ...
                            <td><a class="btn btn-info" href ="${bk.pdf}" ><span class="glyphicon glyphicon-download">Download</span></a></td>
                            <td><a class="btn btn-info" href="editbook.jsp?isbn=<c:out value="${bk.ISBN}"/>"><span class="glyphicon glyphicon-pencil">Update</a></span></td>
                            <td><a class="btn btn-info" href="javascript:confirmGo('Sure to delete this record?','delbook.jsp?isbn=<c:out value="${bk.ISBN}"/>')"><span class="glyphicon glyphicon-trash">Delete</a></span></td>

                        </tr>
                    </c:forEach>
                </tbody>
            </table>
            <a class="btn btn-info" href="addbook.jsp">ADD BOOK<span class="glyphicon glyphicon-book"></span></a>
        </div>
