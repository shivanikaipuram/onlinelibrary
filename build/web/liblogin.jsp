<%-- 
    Document   : liblogin
    Created on : Jul 8, 2016, 12:38:29 PM
    Author     : shivani
--%>
    ...
    <body class="body">
        <div style="background-color:black;
            ...
            <div class="container col-sm-4 text-center" style="border:10px; background-color: black; color: white; float: center">
                <br><br>
                <form method="post" action="liblogindb.jsp" role="form">
                    <div class="form-group">
                        <input type="text" class="form-control" name = "login" id="login" value="" placeholder="Enter email">
                    </div>
                    <div class="form-group">
                ...
                <div>
                    <p>User? Login in <a href="index.jsp">here!</a></p>
                </div>
                <strong>
